...
void Foam::heNeThermo<BasicPsiThermo, MixtureType>::calculate
(
...
template<class BasicPsiThermo, class MixtureType>
Foam::heNeThermo<BasicPsiThermo, MixtureType>::heNeThermo
(
    const fvMesh& mesh,
...
template<class BasicPsiThermo, class MixtureType>
void Foam::heNeThermo<BasicPsiThermo, MixtureType>::correct()
{
