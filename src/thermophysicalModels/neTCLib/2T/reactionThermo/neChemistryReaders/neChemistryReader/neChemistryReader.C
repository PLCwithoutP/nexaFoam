...
#include "neChemistryReader.H"

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

template<class ThermoType>
Foam::autoPtr<Foam::neChemistryReader<ThermoType>>
Foam::neChemistryReader<ThermoType>::New
(
...
)
{
    ...
    return autoPtr<neChemistryReader<ThermoType>>
    (
