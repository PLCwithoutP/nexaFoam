...
#include "basicMultiComponent2TMixture.H"

// * * * * * * * * * * * * * Static Member Functions * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(basicMultiComponent2TMixture, 0);
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::basicMultiComponent2TMixture::basicMultiComponent2TMixture
(
...
:
    basic2TMixture(thermoDict, mesh, phaseName),
    ...
    Y_(species_.size())
{
    ...
    forAll(species_, i)
    {
        ...
        {
            DebugInfo
                << "basicMultiComponent2TMixture: reading " << species_[i]
                << endl;
