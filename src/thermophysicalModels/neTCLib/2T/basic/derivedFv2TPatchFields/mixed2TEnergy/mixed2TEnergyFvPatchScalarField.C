...
Foam::mixed2TEnergyFvPatchScalarField::
mixed2TEnergyFvPatchScalarField
(
    const fvPatch& p,
...
mixed2TEnergyFvPatchScalarField
(
    const mixed2TEnergyFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
mixed2TEnergyFvPatchScalarField
(
    const mixed2TEnergyFvPatchScalarField& tppsf
)
:
...
void Foam::mixed2TEnergyFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::mixed2TEnergyFvPatchScalarField::manipulateMatrix
(
