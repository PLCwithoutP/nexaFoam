...
void Foam::heTThermo<BasicThermo, MixtureType>::
...
template<class BasicThermo, class MixtureType>
void Foam::heTThermo<BasicThermo, MixtureType>::init
(
...
template<class BasicThermo, class MixtureType>
Foam::heTThermo<BasicThermo, MixtureType>::heTThermo
(
    const fvMesh& mesh,
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField> Foam::heTThermo<BasicThermo, MixtureType>::he
(
    const volScalarField& p,
    const volScalarField& T
) const
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::heTThermo<BasicThermo, MixtureType>::he
(
    const scalarField& p,
    const scalarField& T,
...
Foam::heTThermo<BasicThermo, MixtureType>::hc() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::heTThermo<BasicThermo, MixtureType>::Cp
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::heTThermo<BasicThermo, MixtureType>::Cp
(
    const scalarField& p,
    const scalarField& T,
    const labelList& cells
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::heTThermo<BasicThermo, MixtureType>::Cp() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField>
Foam::heTThermo<BasicThermo, MixtureType>::Cv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField>
Foam::heTThermo<BasicThermo, MixtureType>::rhoEoS
(
    const scalarField& p,
    const scalarField& T,
    const labelList& cells
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::heTThermo<BasicThermo, MixtureType>::Cv() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::heTThermo<BasicThermo, MixtureType>::gamma
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::heTThermo<BasicThermo, MixtureType>::gamma() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::heTThermo<BasicThermo, MixtureType>::Cpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::heTThermo<BasicThermo, MixtureType>::Cpv() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::heTThermo<BasicThermo, MixtureType>::CpByCpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::heTThermo<BasicThermo, MixtureType>::CpByCpv() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::heTThermo<BasicThermo, MixtureType>::THE
(
    const scalarField& h,
    const scalarField& p,
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField> Foam::heTThermo<BasicThermo, MixtureType>::W
(
) const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::heTThermo<BasicThermo, MixtureType>::kappa() const
{
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::heTThermo<BasicThermo, MixtureType>::kappa
(
    const label patchi
) const
{
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::heTThermo<BasicThermo, MixtureType>::alphahe() const
{
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField>
Foam::heTThermo<BasicThermo, MixtureType>::alphahe(const label patchi) const
{
    return
    this->CpByCpv
    (
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::heTThermo<BasicThermo, MixtureType>::kappaEff
(
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::heTThermo<BasicThermo, MixtureType>::alphaEff
(
    const volScalarField& alphat
) const
{
...
template<class BasicThermo, class MixtureType>
bool Foam::heTThermo<BasicThermo, MixtureType>::read()
{
    if (BasicThermo::read())
    {
