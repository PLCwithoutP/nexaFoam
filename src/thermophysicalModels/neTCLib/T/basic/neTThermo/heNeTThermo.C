...
template<class BasicNeTThermo, class MixtureType>
void Foam::heNeTThermo<BasicNeTThermo, MixtureType>::calculate
(
...
template<class BasicNeTThermo, class MixtureType>
Foam::heNeTThermo<BasicNeTThermo, MixtureType>::heNeTThermo
(
    const fvMesh& mesh,
    const word& phaseName
)
:
    heTThermo<BasicNeTThermo, MixtureType>(mesh, phaseName)
{
    calculate
    (
        this->p_,
...
:
    heTThermo<BasicNeTThermo, MixtureType>(mesh, phaseName, dictionaryName)
{
    calculate
    (
        this->p_,
...
template<class BasicNeTThermo, class MixtureType>
void Foam::heNeTThermo<BasicNeTThermo, MixtureType>::correct()
{
