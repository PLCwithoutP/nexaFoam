...
#include "maxwellSlipU2TFvPatchVectorField.H"
...
Foam::maxwellSlipU2TFvPatchVectorField::maxwellSlipU2TFvPatchVectorField
(
    const fvPatch& p,
...
Foam::maxwellSlipU2TFvPatchVectorField::maxwellSlipU2TFvPatchVectorField
(
    const maxwellSlipU2TFvPatchVectorField& mspvf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
void Foam::maxwellSlipU2TFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::maxwellSlipU2TFvPatchVectorField::write(Ostream& os) const
{
...
namespace Foam
{
    ...
    (
        fvPatchVectorField,
        maxwellSlipU2TFvPatchVectorField
    );
}
